...
export default {
    ...
    "kiwi-cut": { primary_key: "kiwi_halves", secondary_keys: [], images: ["kiwi_cut"], affordances: ["movable"] },
    ...
    "potted-plant": { primary_key: "potted_plant", secondary_keys: [], images: ["pot_plant_crop"], affordances: ["storable-medium", "movable"] },
    ...
    "house": {primary_key: "house", images: ["house_crop", "house_front"]},
    "car-old-movable": {primary_key: "car", images: ["car_blue_old_crop"], affordances: ["movable", "parkable"], color: "blue"},
    "parking-lot": {primary_key: "parking_lot", images: ["parking_lot_1", "parking_lot_2"], affordances: ["is-parking-space"]}
};
